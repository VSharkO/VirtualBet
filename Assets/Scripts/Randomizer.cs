...
public class Randomizer : MonoBehaviour {
    ...
    public Text klub1,klub2,klub3,klub4,klub5,klub6,klub7,klub8,koef11,koef12,koef1x,koef21,koef22,koef2x,koef31,koef32,koef3x,koef41,koef42,koef4x,posibleGain;
    koef koef1, koef2, koef3, koef4;
    Club Klub1, Klub2, Klub3, Klub4, Klub5, Klub6, Klub7, Klub8;
    char[] prognoza;
    ...
    public void ShowPosibleGain() {
        ...
        prognoza[1] = bet1.text.ToCharArray()[0];
        prognoza[2] = bet1.text.ToCharArray()[0];
        prognoza[3] = bet1.text.ToCharArray()[0];
    ...
    public double getPosGain() {
        ...
        Debug.Log("uloženo: " + double.Parse(betAmount.text));
        return gainKoef;
    }
    public char[] getResults(Club[,] parovi)
    {
        double rnd1 = Random.Range(1f, 1.4f);
        double rnd2 = Random.Range(1f, 1.4f);
        ...
        if (hn1 > hn2) { rezultat[1] = '1'; }

        else if (hn1 < hn2) { rezultat[1] = '2'; }

        else { rezultat[1] = 'x'; }

        if (hn3 > hn4) { rezultat[2] = '1'; }

        else if (hn3 < hn4) { rezultat[2] = '2'; }

        else { rezultat[2] = 'x'; }

        if (hn5 > hn6) { rezultat[3] = '1'; }

        else if (hn5 < hn6) { rezultat[3] = '2'; }

        else { rezultat[3] = 'x'; }

        if (hn7 > hn8) { rezultat[4] = '1'; }

        else if (hn7 < hn8) { rezultat[4] = '2'; }
    ...
    //metoda koja pravi koeficijente a predamo joj dva kluba
     koef MakeKoef(Club klub1, Club klub2) {
        ...
        koeficient.getSetKoef1 = (40F/klub1.GetSetStrHome)-(12F / klub2.GetSetStrHome)*rnd1;
